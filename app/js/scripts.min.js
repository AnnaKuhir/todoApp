...
const onEditTodoClick=(event)=>{const id=+event.target.parentNode.id;const todo=getTodoById(id);todo.isEdited=true;renderTodoList(itemContainer,getTodos());initControlTodoListeners();}
const onCancelButtonClick=(event)=>{const id=+event.target.parentNode.id;const todo=getTodoById(id);todo.isEdited=false;renderTodoList(itemContainer,getTodos());initControlTodoListeners();}
...
editTodo(editedTodo);renderTodoList(itemContainer,getTodos());initControlTodoListeners();}

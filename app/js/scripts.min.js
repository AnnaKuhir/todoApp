...
const cancelButtonItems=document.querySelectorAll('.js-cancel-button');if(cancelButtonItems){cancelButtonItems.forEach(item=>{item.addEventListener('click',onEditButtonClick)});}
